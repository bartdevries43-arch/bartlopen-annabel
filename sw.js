...
const CACHE = "runcoach-annabel-v4-feedback-p2-u2-m2-bugfix";
const ASSETS = [
  "./", "./index.html", "./styles.css?v=5-annabel-feedback-p2-u2-m2-bugfix", "./app.js?v=5-annabel-feedback-p2-u2-m2-bugfix",
